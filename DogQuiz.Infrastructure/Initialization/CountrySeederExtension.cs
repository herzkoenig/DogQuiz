...
public static class CountrySeederExtension
{
	public static void SeedCountries(this ModelBuilder modelBuilder)
	{
		...
		// TODO: Convert this list to a JSON file to simplify parsing.
...
""";
		...
		List<Country> countryList = countries
			...
			.Select((line, index) =>
			{
				...
				{
					throw new FormatException($"Invalid country data format at line {index + 1}: {line}");
				}
